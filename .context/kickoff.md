...
>   `https://github.com/TisoneK/glyph.git`, read `.context/kickoff.md`, follow it."* If the
...
- **Project name:** Glyph
- **Project repository URL:** https://github.com/TisoneK/glyph.git
- **Project repo privacy:** Private
- **Default branch:** main
- **Live application:** N/A (research/exploration phase — no app yet)
...
- **Cloud/sandbox agent** — clone the project repo only:
  ...
  git clone <PROJECT_REPO_URL_WITH_TOKEN_IF_PRIVATE> glyph && cd glyph
  git remote set-url origin https://github.com/TisoneK/glyph.git
