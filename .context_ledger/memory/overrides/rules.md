...
- (no active overrides as of 2026-09-23 — the 0.3.x
  `context.schema.json` `coreVersion` drift and the 2.0.3 Windows
  `.ps1` port defects were both fixed upstream; earlier bullets are
  in git history and in `memory/office/flaws/log.md`)
